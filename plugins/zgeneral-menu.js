...
々 – ʀᴜɴᴛɪᴍᴇ : %uptime
々 – ᴘʀᴇғɪx : [ %p ]
々 – ᴍᴏᴅᴇ : ${global.opts['self'] ? 'Private' : 'ᴘᴜʙʟɪᴄ'}
々 – ᴅᴀᴛᴀʙᴀsᴇ : *${Object.keys(global.db.data.users).length}* ᴘᴇɴɢɢᴜɴᴀ 
々 – ᴄʜᴀᴛ ʙᴀɴɴᴇᴅ : *${Object.entries(global.db.data.chats).filter(chat => chat[1].isBanned).length}* ᴄʜᴀᴛ ᴛᴇʀʙᴀɴɴᴇᴅ 
...
await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    thumbnailUrl: 'https://telegra.ph/file/95836e68d71b149f321ef.jpg',
